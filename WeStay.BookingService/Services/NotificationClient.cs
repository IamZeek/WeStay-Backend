...
namespace WeStay.BookingService.Services
{
    ...
    ///
    /// NOTE: direct HTTP is a Phase 1 choice. A message bus would replace these calls later so
    /// notifications are produced as events rather than synchronous cross-service calls.
    /// </summary>
